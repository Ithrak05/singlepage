...
<body>
    ...
    <main id="main" class="site-main">
        ...
        <section class="site-section section-contact" id="contact">
            <div class="container">
                <div class="frame" style="border-radius: 10px; padding: 20px">
                    <h1 id="form-header" style="text-align : center">Contact Form</h1>
                    <form role="form" id="contactForm" class="contact-form" data-toggle="validator" class="shake">
                    <div class="form-group p-2">
                        <div class="controls">
                        <input type="text" id="name" class="form-control" placeholder="Name" />
                        <span class="error-name" id="error-base">Name required</span>
                        </div>
                    </div>
                    <div class="form-group p-2">
                        <div class="controls">
                        <input type="email" class="form-control" id="email" placeholder="Email" />
                        <span class="error-email" id="error-base">Email required</span>
                        <span class="error-invalid" id="error-base">Invalid email format</span>
                        </div>
                    </div>
                    <div class="form-group p-2">
                        <div class="controls">
                        <input type="text" id="msg_subject" class="form-control" placeholder="Subject" />
                        <span class="error-subject" id="error-base">Subject required</span>
                        </div>
                    </div>
                    <div class="form-group p-2">
                        <div class="controls">
                        <textarea id="message" rows="2" placeholder="Massage" class="form-control"></textarea>
                        <span class="error-message" id="error-base">description required</span>
                        </div>  
                    </div>
        ...
        <script type="text/javascript">
            $(document).ready(function() {
                $('#submit').click(function(e){
                    ...
                    $(".error-subject").css("display", "none")
                    $(".error-message").css("display", "none")
                    $(".error-invalid").css("display", "none")
                    ...
                    $.ajax({
                        ...
                        success : function(data){
                            if (data.code == "200"){
                                ...
                                .append("<p style='text-align:center; padding-top: 10px'>We will be in touch soon.</p>")
                                .hide()
                                .fadeIn(1500, function () {
                                    $("#message").append(
                                        "<p id='call' style='text-align:center'>success!</p>"
                                    );
                                });
                                $("#form-header").hide();
                                ...
                                for(var g = 0; g < error_len; g++){
                                if(error[g] == "name"){
                                    $(".error-name").css("display", "block")
                                    $(".frame").css("border", "2px solid red")
                                    $(".frame").css("transition", "2s")
                                }else if(error[g] == "email" || error[g] == "Invalid email format"){
                                    if(error[g] == "email") {
                                    $(".error-email").css("display", "block")
                                    }else if(error[g] == "Invalid email format"){
                                    $(".error-invalid").css("display", "block")
                                    }
                                    $(".frame").css("border", "2px solid red")
                                    $(".frame").css("transition", "2s")
                                }else if(error[g] == "subject"){
                                    $(".error-subject").css("display", "block")
                                    $(".frame").css("border", "2px solid red")
                                    $(".frame").css("transition", "2s")
                                }else if(error[g] == "message"){
                                    $(".error-message").css("display", "block")
                                    $(".frame").css("border", "2px solid red")
                                    $(".frame").css("transition", "2s")
                                }else{
                                    $("#error-base").css("display", "none")
                                }
                                }   
                            }
                        }
